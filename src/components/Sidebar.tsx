    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <button onClick={onClose} className="w-full flex items-center gap-3 px-4 py-3 text-stone-700 hover:bg-[#E5F5E9] hover:text-[#165B33] font-bold rounded-xl transition-colors">
