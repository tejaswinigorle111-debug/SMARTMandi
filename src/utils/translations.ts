...
export const translations = {
  en: {
    ...
    input: {
      ...
      presetTomato: '1,000 kg Tomato',
      presetCotton: '3,000 kg Cotton',
      presetChilli: '800 kg Chilli',
      presetMaize: '2,000 kg Maize',
      voiceLabel: 'Voice:',
      langSwitch: 'EN / मराठी',
      ...
      cards: [
        {
          ...
          description: 'Recommendations consider your specific crop type, volume in kilograms, and provided location.',
        },
        {
          tag: 'BEYOND PRICE',
  ...
  mr: {
    ...
    input: {
      ...
      quickPresetsLabel: 'जलद निवड:',
      presetTomato: '१००० किलो टोमॅटो',
      presetCotton: '३००० किलो कापूस',
      presetChilli: '८०० किलो मिरची',
      presetMaize: '२००० किलो मका',
      voiceLabel: 'आवाज:',
      langSwitch: 'EN / मराठी',
    ...
    results: {
      ...
      recommendationBasis: 'स्मार्ट मार्केट स्कोअर (Smart Market Score) आधारित शिफारस',
    ...
    howItWorks: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'केवळ वरवर दिसणारा जास्त दर न पाहता, वाहतूक खर्च वजा करून अंदाजित निव्वळ नफा जास्त देणारी बाजारपेठ निवडा.',
        },
      ],
    },
    whySmartMandi: {
